package com.jtech.sbg.interceptor;
...
public class StatusTraceInterceptor implements TraceInterceptor {

    private static final Logger LOGGER = LoggerFactory.getLogger(StatusTraceInterceptor.class);
